...
const artwork = {
  support: `<svg viewBox="0 0 300 300" aria-hidden="true"><defs><linearGradient id="hero-support-paper-1" x1="0%" y1="0%" x2="95%" y2="85%"><stop offset="0.0%" stop-color="#fbf6e0"/><stop offset="100.0%" stop-color="#f7f1db"/></linearGradient><linearGradient id="hero-support-paper-6" x1="0%" y1="0%" x2="95%" y2="85%"><stop offset="0.0%" stop-color="#dbe5c2"/><stop offset="50.0%" stop-color="#d8e3bf"/><stop offset="100.0%" stop-color="#d2dfb9"/></linearGradient><linearGradient id="hero-support-paper-7" x1="0%" y1="0%" x2="95%" y2="85%"><stop offset="0.0%" stop-color="#859973"/><stop offset="100.0%" stop-color="#7d926c"/></linearGradient><filter id="ground-support" x="-50%" y="-400%" width="200%" height="900%"><feGaussianBlur stdDeviation="7"/></filter><filter id="contact-support" x="-50%" y="-200%" width="200%" height="500%"><feGaussianBlur stdDeviation="1.8"/></filter></defs><g stroke="none" fill="#756b4d" aria-hidden="true"><ellipse cx="145" cy="275.5" rx="89" ry="8" opacity=".16" filter="url(#ground-support)"/><g opacity=".25" filter="url(#contact-support)"><ellipse cx="69" cy="281" rx="17" ry="2.7"/><ellipse cx="211" cy="270" rx="17" ry="2.7"/></g></g><path class="hero-legs limb" d="M90.7877811146455 238.3035033938028 Q85.39389055732275 257.6517516969014 80 277 L59 282 M196.313999093285 220.57732729390295 Q197.6569995466425 243.28866364695148 199 266 L222 270"/><g class="body" transform="translate(150 235) rotate(-9) translate(-150 -235)">
  ...
  slides: `<svg viewBox="0 0 300 300" aria-hidden="true"><defs><linearGradient id="hero-slides-paper-0" x1="0%" y1="0%" x2="95%" y2="85%"><stop offset="0.0%" stop-color="#f7c55d"/><stop offset="50.0%" stop-color="#f5c156"/><stop offset="100.0%" stop-color="#f3bd51"/></linearGradient><linearGradient id="hero-slides-paper-1" x1="0%" y1="0%" x2="95%" y2="85%"><stop offset="0.0%" stop-color="#fbf6e0"/><stop offset="100.0%" stop-color="#f7f1db"/></linearGradient><linearGradient id="hero-slides-paper-2" x1="0%" y1="0%" x2="95%" y2="85%"><stop offset="0.0%" stop-color="#e99458"/><stop offset="100.0%" stop-color="#e79054"/></linearGradient><filter id="ground-slides" x="-50%" y="-400%" width="200%" height="900%"><feGaussianBlur stdDeviation="7"/></filter><filter id="contact-slides" x="-50%" y="-200%" width="200%" height="500%"><feGaussianBlur stdDeviation="1.8"/></filter></defs><g stroke="none" fill="#756b4d" aria-hidden="true"><ellipse cx="149.5" cy="248.5" rx="98.5" ry="8" opacity=".16" filter="url(#ground-slides)"/><g opacity=".25" filter="url(#contact-slides)"><ellipse cx="64" cy="255" rx="17" ry="2.7"/><ellipse cx="225" cy="242" rx="17" ry="2.7"/></g></g><path class="hero-legs limb" d="M82 211 Q77.5 231 73 251 L55 256 M213 205 Q215 222 217 239 L234 242"/><g class="body" transform="translate(150 235) rotate(0) translate(-150 -235)">
  ...
  activity: `<svg viewBox="0 0 300 300" aria-hidden="true"><defs><linearGradient id="hero-activity-paper-1" x1="0%" y1="0%" x2="95%" y2="85%"><stop offset="0.0%" stop-color="#fbf6e0"/><stop offset="100.0%" stop-color="#f7f1db"/></linearGradient><linearGradient id="hero-activity-paper-3" x1="0%" y1="0%" x2="95%" y2="85%"><stop offset="0.0%" stop-color="#faf7eb"/><stop offset="50.0%" stop-color="#f9f6e9"/><stop offset="100.0%" stop-color="#f7f4e6"/></linearGradient><linearGradient id="hero-activity-paper-4" x1="0%" y1="0%" x2="95%" y2="85%"><stop offset="0.0%" stop-color="#d0dfec"/><stop offset="100.0%" stop-color="#c9dae7"/></linearGradient><linearGradient id="hero-activity-paper-5" x1="0%" y1="0%" x2="95%" y2="85%"><stop offset="0.0%" stop-color="#cddab0"/><stop offset="100.0%" stop-color="#c7d6aa"/></linearGradient><filter id="ground-activity" x="-50%" y="-400%" width="200%" height="900%"><feGaussianBlur stdDeviation="7"/></filter><filter id="contact-activity" x="-50%" y="-200%" width="200%" height="500%"><feGaussianBlur stdDeviation="1.8"/></filter></defs><g stroke="none" fill="#756b4d" aria-hidden="true"><ellipse cx="148.5" cy="271.5" rx="78.5" ry="8" opacity=".16" filter="url(#ground-activity)"/><g opacity=".25" filter="url(#contact-activity)"><ellipse cx="83" cy="270" rx="17" ry="2.7"/><ellipse cx="204" cy="273" rx="17" ry="2.7"/></g></g><path class="hero-legs limb" d="M99 229 Q95.5 248 92 267 L74 271 M190 235 Q192.5 252.5 195 270 L213 274"/><g class="body" transform="translate(150 235) rotate(0) translate(-150 -235)">
  ...
  answers: `<svg viewBox="0 0 300 300" aria-hidden="true"><defs><linearGradient id="hero-answers-paper-8" x1="0%" y1="0%" x2="95%" y2="85%"><stop offset="0.0%" stop-color="#f1b098"/><stop offset="50.0%" stop-color="#efaa92"/><stop offset="100.0%" stop-color="#eca68e"/></linearGradient><linearGradient id="hero-answers-paper-9" x1="0%" y1="0%" x2="95%" y2="85%"><stop offset="0.0%" stop-color="#d98a72"/><stop offset="100.0%" stop-color="#d3836b"/></linearGradient><filter id="ground-answers" x="-50%" y="-400%" width="200%" height="900%"><feGaussianBlur stdDeviation="7"/></filter><filter id="contact-answers" x="-50%" y="-200%" width="200%" height="500%"><feGaussianBlur stdDeviation="1.8"/></filter></defs><g stroke="none" fill="#756b4d" aria-hidden="true"><ellipse cx="160.5" cy="278" rx="63.5" ry="8" opacity=".16" filter="url(#ground-answers)"/><g opacity=".25" filter="url(#contact-answers)"><ellipse cx="110" cy="273" rx="17" ry="2.7"/><ellipse cx="201" cy="283" rx="17" ry="2.7"/></g></g><path class="hero-legs limb" d="M115.62649272276917 227.75693452589587 Q117.81324636138459 248.37846726294794 120 269 L101 273 M180.1419925794551 235.67844184723046 Q186.07099628972753 257.33922092361524 192 279 L209 283"/><g class="body" transform="translate(150 235) rotate(7) translate(-150 -235)">
...
export function heroCharacter(kind, className) {
  ...
  return `<div class="hm-actor hm-${className}" data-hero-actor="${kind}" data-hero-pose="${escapeHtml(JSON.stringify(pose))}" aria-hidden="true">${artwork[kind]}</div>`;
}
