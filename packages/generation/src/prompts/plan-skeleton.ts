...
export const planSkeletonPrompt = {
  ...
  system: [
    ...
    'Say whether the topic can be photographed — "photographable": { "yes", "why": one sentence } — by this test: a real place, object, organism, material, weather, artefact or everyday scene is; a diagram, map, chart, process or abstract idea is not. When it is, one explain slide is an "image-text" slide. An "image-text" slide shows one photograph of a real thing beside the text. Give it "imageBrief": { "subject": the exact query for a stock-photo search engine that knows nothing about this lesson — two to five plain words, British English. Prefer a real, named, much-photographed example over a category: a named site, monument, specimen, artefact or landmark that stands for the topic ("Hadrian\'s Wall", not "Roman fort Britain"; "red squirrel", not "small mammal"; "River Severn", not "river"); use a category only when no named example exists. The topic decides what an ambiguous word means ("oak leaf", never "leaf"), and a part or property alone is never enough, "mustShow": two or three concrete things a pupil could see for the slide\'s task, each a different external feature so that an ordinary photograph of that named subject, as a stranger would take it, is likely to show at least one of them — nouns a camera captures ("open flower", "petals", "stem"); the slide\'s text is written to whichever are actually visible; a part seen only in a close-up or when the subject is doing something (teeth, tongue, roots, the inside of anything) is not a "mustShow" item — the slide\'s text names it instead; never a process, or the kind of thing itself, which belongs in "subject"; "purpose": "identify-parts" | "observe" | "compare" | "context"; "avoid": what would spoil the picture for pupils — for a living subject usually a cage, fence, bars, glass or hands in front of it }. At most three image-text slides in a lesson.',
