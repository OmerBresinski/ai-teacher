...
export interface StoredPhoto {
  key: string;
  /**
   * Our URL for the bytes, served by the api's file proxy, always the relative `/files/<key>`
   * (TEACH-275): documents never carry the api origin; the web resolves it at render.
   */
  url: string;
