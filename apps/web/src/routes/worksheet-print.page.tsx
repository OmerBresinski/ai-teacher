 ...
 * waits. A lesson id on a worksheet route shows the stub, as the lesson routes do for worksheets.
 */
export function WorksheetPrintPage() {
  ...
  if (kindOf(data) !== "worksheet" || !("blocks" in data)) return <EditorStubPage />;
