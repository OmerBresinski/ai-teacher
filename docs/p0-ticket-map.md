...
| 1 | TEACH-13 | `@tj/ui`: Tailwind v4 + shadcn plumbing, theme switching | 11 |
...
| 3 | TEACH-16 | `apps/api` (Hono) + `@tj/api-client` | 12, 14 |
| 3 | TEACH-17 | `apps/worker` + `@tj/jobs` (pg-boss, ping job, events) | 12, 14 |
| 4 | TEACH-19 | Job endpoints + SSE with replay | 16, 17 |
| 4 | TEACH-20 | Auth skeleton (better-auth, personal workspace) | 14, 16 |
| 4 | TEACH-21 | `apps/web` (Vite + React, TanStack Router code-based) | 13, 16 |
| 5 | TEACH-22 | Test harness (Vitest, bun test DB, Playwright + axe) | 19, 20, 21 |
| 5 | TEACH-24 | Dockerfile + Railway (api, worker, PG, PR envs) | 16, 17, 20 |
| 5 | TEACH-25 | Vercel deploy (SPA, previews, Speed Insights) | 21 |
